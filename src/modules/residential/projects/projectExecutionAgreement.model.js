...
const projectExecutionAgreementSchema = new mongoose.Schema(
  {
    projectId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "Project",
    ...
    contractValueTotal: { type: Number, default: 0 },
...
export default mongoose.model(
  "ProjectExecutionAgreement",
  projectExecutionAgreementSchema,
);
